<?php 
  ...
  //$rootPath =  $_SERVER['DOCUMENT_ROOT'] . "/" . dirname(__FILE__);
  //print_r($rootPath. "/" . dirname(__FILE__) . '\assets\library\devtz007\css\reset.css');
  //print_r($rootPath . "</br>");
  //$getCwd = getcwd();
  //print_r($getCwd . "</br>");
    ...
    <header class="myHeader">
        <div class="upper-header">
            <div class="website-logo">
                <img src="<?php $rootPath?>/assets/components/header/images/logo_transparent.png" alt="" />
            </div>
            <div class="website-name">
                <div class="item item-1">Detective Training School (DTS)</div>
                <div class="item item-2">Bangladesh Police</div>
            </div>
            <div class="contact">

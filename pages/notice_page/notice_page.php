...
<main class="main-p-top main-p-bot">
    <section class="notice-board sec-gap sec-x-p">
        <div class="section-heading">All Notices</div>
        <div class="notice-list-cont">
            <div class="notice-item">
                <a href="<?php $rootPath?>/pages/notice_page/read_notice_page.php">
		...
		s0.348-0.07,0.474-0.197l9.647-9.646C15.881,10.531,15.881,10.104,15.621,9.844z" />
                    ...
                    <button class="pagination-number pagination-arrow">
                        <span class="svg-cont">
...
<?php require "$rootPath/footer.php";?>
        ...
        <section class="slider-sec">
            <div class="slider-wrapper">
                <div class="images-cont">
                    <img class="slider-img" src="./assets/components/slider/images/a1.jpeg">
                    <img class="slider-img" src="./assets/components/slider/images/a2.jpeg">
                    <img class="slider-img" src="./assets/components/slider/images/a3.jpeg">
                    <img class="slider-img" src="./assets/components/slider/images/a4.jpeg">
                    <img class="slider-img" src="./assets/components/slider/images/a5.jpeg">
...
-->
            ...
            <div class="commandant-wrapper">
                ...
                <div class="image-cont">
                    <img src="./assets/components/slider/images/dummy.webp" alt="commandant officer's picture">
                    <div class="info">
        ...
        <div class="make-col-2">
            ...
            <div class="col-1">
                <section class="who-we-are article-type-1-cont sec-gap">

               
                <div class="article-type-1">
                    <h3 class="section-heading">Who we are</h3>
                    <p>
        Detective Training School (DTS) is maintained by Criminal Investigation Department (CID) of Bangladesh Police. It arranges various courses in the area of
        investigation and supervision. Since the inception this institute has produced a good number of highly professional
        investigating and detective officers. It is headed by a senior police officer in the rank of Additional DIG designated
        as the Commandant of this school. It was established on 25 July 1962.

                    </p>
                </div>
                </section>
                <section class="objectives sec-gap">

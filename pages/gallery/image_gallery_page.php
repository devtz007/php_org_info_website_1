...
?>
<main class="gallery-page pad-y-30px">
        ...
        <div>
            <div class="photo-gallary-mosaic-image-conatainer ">
                <div id="img1 " class="photo-gallary-mosaic-child ">
                    <img src="<?php $rootPath ?>/assets/components/photo_gallery_comp/img1.jpg " alt="">
                ...
                <div id="img3 " class="photo-gallary-mosaic-child ">
                    <img src="<?php $rootPath ?>/assets/components/photo_gallery_comp/img3.jpg " alt=" ">
                </div>
                ...
                <div id="img5 " class="photo-gallary-mosaic-child ">
                    <img src="<?php $rootPath ?>/assets/components/photo_gallery_comp/img5.jpg " alt=" ">
                </div>
                <div id="img6 " class="photo-gallary-mosaic-child ">
                    <img src="<?php $rootPath ?>/assets/components/photo_gallery_comp/img6.jpg " alt=" ">
                </div>
